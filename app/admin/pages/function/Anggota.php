...
if ($_GET['aksi'] == "tambah") {
    ...
    $query = "UPDATE administrator SET nis = '$nis', fullname = '$nama_lengkap', username = '$username', 
    ...
    $sql = mysqli_query($koneksi, "DELETE FROM administrator WHERE id_user = $id_user");
